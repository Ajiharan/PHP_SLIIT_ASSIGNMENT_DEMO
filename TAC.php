...
<table style="background-color:white" width="100%" height="57">
  ...
  <img src="image/home/tac.png" style="width:100%">
	...
	<table width="50%" align="center">
		<tr>
			<td>
				...
				<p>3. Monthly pricing: Available to qualified customers and requires 0% APR, 24-month installment loan with Citizens One or Apple Card Monthly Installments and iPhone activation with AT&T, Sprint, T-Mobile, or Verizon for purchases in an Apple Store. Taxes and shipping not included. Additional Apple Card Monthly Installments and iPhone Payments terms apply.</p>
				<p>4. $9.99/month after free trial. No commitment. Plan automatically renews after trial until cancelled.,To access and use all the features of Apple Card, you must add Apple Card to Wallet on an iPhone or iPad with iOS or iPadOS 13.2 or later. Update to the latest version of iOS or iPadOS by going to Settings > General > Software Update. Tap Download and Install.</p>
			</td>
		</tr>
		<tr>
			<td>
				<h3>1. ORDERING AND PAYMENT</h3>
			</td>
		</tr>
		<tr>
			<td>
				<p>We must receive payment in full for the price of goods that you order prior to our acceptance of your order. Once payment in full has been received by us we shall acknowledge receipt of your order by sending you an email to the email address that you provided in your order form. This does not constitute our acceptance of your order.<br><br>Our acceptance of your order takes place when we dispatch the goods ordered unless we have previously notified you that we do not accept your order or you have cancelled your order in accordance with the cancellation clause below.<br><br>Our acceptance of your order brings into existence a legally binding contract between us. We do not accept orders from persons under the age of 18 or from persons who are unable or are not authorised to enter into legally binding contracts through this site. If you do not qualify to do so do not use this site.<br><br>We reserve the right not to accept your order if:
				<ul>
				  <li>we have insufficient stock to deliver the goods you have requested; or</li>
				  <li>we do not deliver to your area; or</li>
				  <li>one or more of the items you ordered was priced incorrectly due to a typographical error or resulting from a fluctuation in the prices of precious metals or gems.</li>
				   <li>If we do not accept your order we will notify you by email or by telephone and we will credit your account with any sum deducted by us from your credit card as soon as possible but in any event within 30 days of your order.</li>
				  <li>We shall not be obliged to offer any compensation for disappointment suffered.</li>
				</ul>
				</p>
		...
		<tr>
			<td>
				<h3>2. CANCELATION, RETURNS AND REFUNDS</h3>
			</td>
		</tr>
		<tr>
			<td>
				<p>You may cancel your order with us for the goods you have purchased at any time up to close of business on the 7th working day from the date you received confirmation of your order. You do not need to give us any reason for cancelling your order and we will not charge any penalty.<br><br>To cancel your order you must notify us by email at info@apple.lk or telephone us on +77 9988998.</p>
			</td>
		</tr>
		<tr>
			<td>
